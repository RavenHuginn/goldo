...
/////////////////////////////////////////////////////////////////////////////
void WalletLegacy::RestoreReadOnly(const std::string& password, const CryptoNote::AccountPublicAddress& address, const Crypto::SecretKey& viewkey) {
    ...
    m_account.create_read_only(address,viewkey);
    m_password = password;
